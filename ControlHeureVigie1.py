...
##                print(row)
                if "equipe" in row[0]:
                    ...
                    for equipe in ['A','B','C','D','E','F']:
                        chaine="Planning "+ equipe + " " + str(annee) + ".xls"
...
def rdm_forfait(dat,l_forfait,gamma):
    ...
    tourbm="TOUR:{0} ; APP/BM:{1}".format(tour,appbm)
    ...
    l_rdm.append(tourbm) #ajoute la répartition tour/babm
    return l_rdm
...
class nom_trig:
    ...
    def __init__(self,dossier=""):
        nomfic=os.path.join(dossier,"noms et trigrammes.xlsx")
    ...
    def export_vers_dhc(self,l_vac):
        ...
        for l in l_vac:
            ...
            for val in l:
                ...
                if col!=1 and col!=7: #sauf en colonne A et G
